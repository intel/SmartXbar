...
IasIModuleId::IasResult IasSimpleVolumeCmd::setProperty(IasProperties &properties)
{
  float newVolume = 0.0f;
  IasProperties::IasResult status = properties.get("volume", &newVolume);
...
IasIModuleId::IasResult IasSimpleVolumeCmd::getProperty(IasProperties &properties)
{
  properties.clearAll();
