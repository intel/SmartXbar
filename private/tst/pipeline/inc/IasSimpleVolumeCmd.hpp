...
class IAS_AUDIO_PUBLIC IasSimpleVolumeCmd : public IasIModuleId
{
  public:
     ...
     *
     * @param[out] properties class which contains vectors for all available, key/value based properties like int32, float32, string, buffer.
     * @return     an error value of type IasRpcModuleInterfaceReturnCodes is returned to indicate success or not
     */
    virtual IasIModuleId::IasResult setProperty( IasProperties &properties);
     ...
     * @return     an error value of type IasRpcModuleInterfaceReturnCodes is returned to indicate success or not
     */
    virtual IasIModuleId::IasResult getProperty( IasProperties &properties);
