...
class IAS_AUDIO_PUBLIC IasSimpleVolumeCore : public IasGenericAudioCompCore
{
  ...
  private:
     ...
     *
     *  The event will contain a IasProperties object with one key/value pair: "volume"/volume
     *
     *  @param volume  The value that shall be used for the key/value pair.
     */
    void sendSimpleVolumeEvent(float);
