...
LOCAL_C_INCLUDES := \
    ...
    $(LOCAL_PATH)/../private/tst/switchmatrixjob/inc

LOCAL_SRC_FILES := \
    ../private/tst/switchmatrixjob/src/main.cpp \
    ../private/tst/switchmatrixjob/src/IasSwitchMatrixJobTest.cpp
...
LOCAL_MODULE := audio_switchmatrixjob_test
