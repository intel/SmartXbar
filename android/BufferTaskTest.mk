...
LOCAL_C_INCLUDES := \
    ...
    $(LOCAL_PATH)/../private/tst/buffertask/inc

LOCAL_SRC_FILES := \
    ../private/tst/buffertask/src/main.cpp \
    ../private/tst/buffertask/src/IasBufferTaskTest.cpp
...
LOCAL_MODULE := audio_buffertask_test
